...
pacman::p_load(dplyr,
               ...
               boot,
               gt,
               fixest) # complex data cleaning (e.g. pivot_wider)
...
cm <- c("n" = "Number of Media Articles",
        ...
        "party_leader_11 1 - 0" = "Party Leader (2)",
        ...
        "party_leader_1 1 - 0" = "Party Leader (2)",
        "party_leader_11" = "Party Leader (2)",
        ...
        "n:party_leader_1" = "Number of Media Articles x Party Leader (2)",
        ...
        "treated_media:party_leader_11" = "Media Salience x Party Leader (2)",
        ...
        "treatment:party_leader_11" = "Exogenous Shock x Party Leader (2)",
        ...
        "n:party_leader_11" = "Number of Media Articles x Party Leader (2)",
...
# FE Models
models1 <- list()
models1[['1.1']] <- fixest::feglm(treated_topic ~ treated_media*party_leader_1 + treated_topic_lag1|politician_id, data = data_war, family = binomial(link = "logit"))
models1[['1.2']] <- fixest::feglm(treated_topic ~ treated_media*party_leader_1 + treated_topic_lag1  + treatment |politician_id,  data = data_war, family = binomial(link = "logit"))
models1[['1.3']] <- fixest::feglm(treated_topic ~ treated_media*party_leader_1 + treated_topic_lag1| politician_id, data = data_gau, family = binomial(link = "logit"))
models1[['1.4']] <- fixest::feglm(treated_topic ~ treated_media*party_leader_1 + treated_topic_lag1 + treatment | politician_id, data = data_gau, family = binomial(link = "logit"))
models1[['1.5']] <- fixest::feglm(treated_topic ~ treated_media*party_leader_1 + treated_topic_lag1| politician_id, data = data_pooled, family = binomial(link = "logit"))
models1[['1.6']] <- fixest::feglm(treated_topic ~ treated_media*party_leader_1 + treated_topic_lag1 + treatment | politician_id, data = data_pooled, family = binomial(link = "logit"))
...
gtExtras::gtsave_extra(table1, "table_h1_b_path_lo_partyleader1.png", path = "tables", zoom = 10, expand = 5)
...
gtExtras::gtsave_extra(table1, "table_h1_b_path_ame_partyleader1.png", path = "tables", zoom = 10, expand = 5)
...
models1 <- list()
models1[['1.1']]  <- fixest::feglm(treated_topic ~ treatment*party_leader_1 | politician_id + session_id, data = data_war, family = binomial(link = "logit"))
models1[['1.2']]  <- fixest::feglm(treated_topic ~ treatment*party_leader_1 + treated_topic_lag1 | politician_id + session_id, data = data_war, family = binomial(link = "logit"))

models1[['1.3']]  <- fixest::feglm(treated_topic ~ treatment*party_leader_1 | politician_id + session_id, data = data_gau, family = binomial(link = "logit"))
models1[['1.4']]  <- fixest::feglm(treated_topic ~ treatment*party_leader_1 + treated_topic_lag1 | politician_id + session_id, data = data_gau, family = binomial(link = "logit"))

models1[['1.5']]  <- fixest::feglm(treated_topic ~ treatment*party_leader_1 | politician_id + session_id, data = data_gau, family = binomial(link = "logit"))
models1[['1.6']]  <- fixest::feglm(treated_topic ~ treatment*party_leader_1 + treated_topic_lag1 | politician_id + session_id, data = data_gau, family = binomial(link = "logit"))
...
gtExtras::gtsave_extra(table1, "table_h1_c_path_lo_partyleader1.png", path = "tables", zoom = 10, expand = 5)
...
gtExtras::gtsave_extra(table1, "table_h1_c_path_ame_partyleader1.png", path = "tables", zoom = 10, expand = 5)
...
# Path Analysis Aggregated -----------------------------------------------------

## B Path ----------------------------------------------------------------------

models2 <- list()
models2[['1.1']] <- fixest::fepois(n_speeches ~ treatment + n*party_leader_1 + government + lag_n_speeches | classification, data = data_war_agg)
models2[['1.2']] <- fixest::fepois(n_speeches ~ treatment + n*party_leader_1 + government + lag_n_speeches | classification + date, data = data_war_agg)

models2[['1.3']] <- fixest::fepois(n_speeches ~ treatment + n*party_leader_1 + government + lag_n_speeches | classification, data = data_gau_agg)
models2[['1.4']] <- fixest::fepois(n_speeches ~ treatment + n*party_leader_1 + government + lag_n_speeches | classification + date, data = data_gau_agg)

models2[['1.5']] <- fixest::fepois(n_speeches ~ treatment + n*party_leader_1 + government + lag_n_speeches | classification, data = data_pool_agg)
models2[['1.6']] <- fixest::fepois(n_speeches ~ treatment + n*party_leader_1 + government + lag_n_speeches | classification + date, data = data_pool_agg)
...
gtExtras::gtsave_extra(table1, "table_b_path_pois_party_leader1.png", path = "tables", zoom = 10, expand = 5)


#- Bootstrapping ---------------------------------------------------------------

mediation1 <- list()
data_war_agg$party_leader_1 <- as.factor(data_war_agg$party_leader_1)
data_gau_agg$party_leader_1 <- as.factor(data_gau_agg$party_leader_1)
data_pool_agg$party_leader_1 <- as.factor(data_pool_agg$party_leader_1)
...
ggsave(filename="Mediation_Analysis_Estimates_1_partyleader1.png", path = "graph", width = 10, height = 6)
...
ggsave(filename="Mediation_Analysis_Props_1_partyleader1.png", path = "graph", width = 10, height = 6)
